...
func (mr *MockWriterMockRecorder) DeleteResource(ctx, group, kind, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWriterMockRecorder) DeleteResourceById(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
