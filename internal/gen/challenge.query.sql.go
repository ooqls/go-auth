...
func (q *Queries) CreateChallenge(ctx context.Context, arg CreateChallengeParams) (Challengesv1, error) {
...
func (q *Queries) GetChallenge(ctx context.Context, id uuid.UUID) (Challengesv1, error) {
