...
func (a *AuthenticatorV1) issueNewAuthToken(ctx context.Context, id authv1.UserId) (string, error) {
...
func (a *AuthenticatorV1) issueNewRefreshToken(ctx context.Context, id authv1.UserId) (string, error) {
	claims := UserClaims{UserID: id}
