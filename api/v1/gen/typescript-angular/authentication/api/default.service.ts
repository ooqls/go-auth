...
// @ts-ignore
import { VerifyKeyRequest } from '../model/verifyKeyRequest';
// @ts-ignore
import { VerifyKeyResp } from '../model/verifyKeyResp';
...
export class DefaultService extends BaseService {
     ...
     */
    public isAuthed(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public isAuthed(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public isAuthed(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public isAuthed(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
    ...
    public loginChallenge(loginChallengeRequest: LoginChallengeRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ChallengeServerResponse>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * verify the given key
     * @param verifyKeyRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public verifyKey(verifyKeyRequest: VerifyKeyRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<VerifyKeyResp>;
    public verifyKey(verifyKeyRequest: VerifyKeyRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<VerifyKeyResp>>;
    public verifyKey(verifyKeyRequest: VerifyKeyRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<VerifyKeyResp>>;
    public verifyKey(verifyKeyRequest: VerifyKeyRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (verifyKeyRequest === null || verifyKeyRequest === undefined) {
            throw new Error('Required parameter verifyKeyRequest was null or undefined when calling verifyKey.');
        }
        ...
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<VerifyKeyResp>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
