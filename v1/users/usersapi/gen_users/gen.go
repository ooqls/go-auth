...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.GET(options.BaseURL+"/auth/user", wrapper.GetCurrentUser)
	router.POST(options.BaseURL+"/auth/user", wrapper.CreateUser)
	router.DELETE(options.BaseURL+"/auth/user/:id", wrapper.DeleteUserByID)
	router.GET(options.BaseURL+"/auth/user/:id", wrapper.GetUserByID)
	router.PUT(options.BaseURL+"/auth/user/:id", wrapper.UpdateUserByID)
	router.GET(options.BaseURL+"/auth/users", wrapper.GetUsers)
}
