...
type Service interface {
	...
	GetUsers(ctx *authorizationv1.Context, page int, pageSize int) ([]User, error)
...
func (u *UserServiceImpl) GetUsers(ctx *authorizationv1.Context, page int, pageSize int) ([]User, error) {
