...
type ResourceList struct {
	Items      []externalRef0.Resource `json:"items"`
	TotalCount int                     `json:"total_count"`
}

// ResourceSearch defines model for ResourceSearch.
...
// PostResourceSearchJSONRequestBody defines body for PostResourceSearch for application/json ContentType.
type PostResourceSearchJSONRequestBody = ResourceSearch
...
type ClientInterface interface {
	...
	// PostResourceSearchWithBody request with any body
	PostResourceSearchWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostResourceSearch(ctx context.Context, body PostResourceSearchJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PostResourceSearchWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostResourceSearchRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostResourceSearch(ctx context.Context, body PostResourceSearchJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostResourceSearchRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostResourceSearchRequest calls the generic PostResourceSearch builder with application/json body
func NewPostResourceSearchRequest(server string, body PostResourceSearchJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostResourceSearchRequestWithBody(server, "application/json", bodyReader)
}

// NewPostResourceSearchRequestWithBody generates requests for PostResourceSearch with any type of body
func NewPostResourceSearchRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/resource/search")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteResourceRequest(server string, group string, kind string, name string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/resource/%s/%s/%s", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostResourceSearchWithBodyWithResponse request with any body
	PostResourceSearchWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostResourceSearchResponse, error)

	PostResourceSearchWithResponse(ctx context.Context, body PostResourceSearchJSONRequestBody, reqEditors ...RequestEditorFn) (*PostResourceSearchResponse, error)
...
type PostResourceSearchResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ResourceList
}
...
// Status returns HTTPResponse.Status
func (r PostResourceSearchResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostResourceSearchResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PostResourceSearchWithBodyWithResponse request with arbitrary body returning *PostResourceSearchResponse
func (c *ClientWithResponses) PostResourceSearchWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostResourceSearchResponse, error) {
	rsp, err := c.PostResourceSearchWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostResourceSearchResponse(rsp)
}

func (c *ClientWithResponses) PostResourceSearchWithResponse(ctx context.Context, body PostResourceSearchJSONRequestBody, reqEditors ...RequestEditorFn) (*PostResourceSearchResponse, error) {
	rsp, err := c.PostResourceSearch(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostResourceSearchResponse(rsp)
...
// ParsePostResourceSearchResponse parses an HTTP response from a PostResourceSearchWithResponse call
func ParsePostResourceSearchResponse(rsp *http.Response) (*PostResourceSearchResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostResourceSearchResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	PostResourceSearch(c *gin.Context)
	// Delete a resource
	// (DELETE /resource/{group}/{kind}/{name})
	DeleteResource(c *gin.Context, group string, kind string, name string)
	// Get a resource
	// (GET /resource/{group}/{kind}/{name})
...
// PostResourceSearch operation middleware
func (siw *ServerInterfaceWrapper) PostResourceSearch(c *gin.Context) {
	...
	siw.Handler.PostResourceSearch(c)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.GET(options.BaseURL+"/resource", wrapper.ListResources)
	router.POST(options.BaseURL+"/resource", wrapper.CreateResource)
	router.PUT(options.BaseURL+"/resource", wrapper.UpdateResource)
	router.POST(options.BaseURL+"/resource/search", wrapper.PostResourceSearch)
	router.DELETE(options.BaseURL+"/resource/:group/:kind/:name", wrapper.DeleteResource)
	router.GET(options.BaseURL+"/resource/:group/:kind/:name", wrapper.GetResource)
}
