...
This is an authentication and authorization application that should be used as the authority for other applications that require authentication/authorization
